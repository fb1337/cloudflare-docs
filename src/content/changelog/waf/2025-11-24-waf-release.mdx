...
This vulnerability enables an unauthenticated attacker to bypass access controls by abusing the CGIINFO header. The latest update strengthens detection logic to ensure reliable identification of crafted requests attempting to exploit this flaw.
